...
class dataVideo(Video):
    ...
    def __init__(self, name, root, video_dir, init_rect_v, img_names_v, img_names_i,
        ...
        super(dataVideo, self).__init__(name, root, video_dir,
...
class dataDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        super(dataDataset, self).__init__(name, dataset_root)
        with open(os.path.join(dataset_root, 'data_visible.json'), 'r') as f:
            meta_data_v = json.load(f)

        with open(os.path.join(dataset_root, 'data_infrared.json'), 'r') as f:
            meta_data_i = json.load(f)

        with open(os.path.join(dataset_root, 'data_init.json'), 'r') as f:
        ...
        for video in pbar:
            ...
            self.videos[video] = dataVideo(video,
                                          dataset_root,
