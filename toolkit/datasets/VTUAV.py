...
class VTUAVDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        super(VTUAVDataset, self).__init__(name, dataset_root)
        with open(os.path.join(dataset_root, 'VTUAV_v.json'), 'r') as f:
            meta_data_v = json.load(f)

        with open(os.path.join(dataset_root, 'VTUAV_i.json'), 'r') as f:
        ...
        for video in pbar:
            ...
            self.videos[video] = VTUAVVideo(video,
                                          dataset_root,
