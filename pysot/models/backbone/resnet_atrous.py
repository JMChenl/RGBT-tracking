...
class ChannelAttentionModule(nn.Module):
    def __init__(self, c1, reduction=16):
        ...
        self.shared_MLP = nn.Sequential(
            nn.Conv2d(in_features=c1, out_features=mid_channel, stride=1, padding=0, bias=False),
            nn.ReLU(),
            nn.Conv2d(in_features=mid_channel, out_features=c1, stride=1, padding=0, bias=False)
        )
